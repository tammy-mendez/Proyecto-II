 ...
 * @author tammy
 */
public class OrdenDeCompra1 extends javax.swing.JFrame {
  int fila;
    int codigo;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrdenDeCompra1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFrame frame=new OrdenDeCompra1();
    ...
    detalleOrdenCompraQuery=entityManager.createNativeQuery("select * from detalle_orden_compra "
      ...
      if (!cps.isEmpty()){
          for (i=0;i<cps.size();i++){
              ...
              doc.setCodOrden(codigo);
              Proveedor p = (Proveedor) obtenerProveedor(tf_proveedor.getText());
              doc.setCodProveedor(p);
