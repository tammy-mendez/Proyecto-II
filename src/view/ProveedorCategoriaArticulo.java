 ...
 * @author pc
 */
public class ProveedorCategoriaArticulo extends javax.swing.JDialog {
    ...
    boolean select;
    String proveedor;
    public ProveedorCategoriaArticulo(java.awt.Frame parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProveedorCategoriaArticulo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProveedorCategoriaArticulo dialog = new ProveedorCategoriaArticulo(new javax.swing.JFrame(), true);
