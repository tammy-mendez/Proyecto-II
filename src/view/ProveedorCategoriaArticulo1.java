 ...
 * @author pc
 */
public class ProveedorCategoriaArticulo1 extends javax.swing.JDialog {
    ...
    boolean select;
    String proveedor;
    public ProveedorCategoriaArticulo1(java.awt.Frame parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProveedorCategoriaArticulo1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProveedorCategoriaArticulo1 dialog = new ProveedorCategoriaArticulo1(new javax.swing.JFrame(), true);
