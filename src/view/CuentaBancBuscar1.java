 ...
 * @author tammy
 */
public class CuentaBancBuscar1 extends javax.swing.JDialog {

    /**
     * Creates new form CuentaBancBuscar
     */
    int cuenta;
    public CuentaBancBuscar1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CuentaBancBuscar1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CuentaBancBuscar1 dialog = new CuentaBancBuscar1(new javax.swing.JFrame(), true);
    ...
    query=entityManager.createNativeQuery("select * from cuenta_bancaria "
            +"where monto_actual> "
            + Integer.parseInt(PagoRegistrar.tf_monto.getText()), CuentaBancaria.class);
